...
<!-- Favicon -->
<link rel="shortcut icon" type="image/png" href="<?= base_url() ?>assets/admin/upload/img/<?= $app['favicon'] ?>" />
<link rel="icon" href="<?= htmlentities(base_url('assets/public/img/'), ENT_QUOTES) ?>" type="image/x-icon" />
...
<link href="<?= base_url() ?>assets/admin/lib/summernote/summernote-lite.min.css" rel="stylesheet">
