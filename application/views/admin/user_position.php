    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="javascript:void()">Jabatan</a>
                </li>
        ...
        <div class="modal-content">
            ...
            <form id="form">
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label for="jabatan" class="col-sm-2 col-form-label">Nama Plugin</label>
                        <div class="col-sm-10">
...
<script>
    ...
    table = new DataTable('#myTables', {
        ...
        order: [],
        ajax: {
            "url": "<?php echo site_url('admin/user_position/dataTables') ?>",
            "type": "POST"
        },
        columnDefs: [{
            "targets": [0],
    ...
    $('#form').submit(function(e) {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/user_position/insertData/') ?>";
        } else {
            url = "<?php echo site_url('admin/user_position/updateData/') ?>";
        }
        $.ajax({
            url: url,
            type: "POST",
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/user_position/get_data_ById/') ?>" + id,
            type: "POST",
            dataType: "JSON",
    ...
    function deletes(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo site_url('admin/user_position/delete/') ?>" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data) {
                        if (data.status == '00') {
