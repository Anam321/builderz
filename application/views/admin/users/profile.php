                        ...
                        <div class="card-body d-flex justify-content-center">
                            ...
                            <section class="profile-card">
                                ...
                                <div class=" justify-content-center">
                                    <a href="<?= base_url('app-admin/profile/edit') ?>" type="button" class="btn btn-sm btn-primary ">Edit Profile</a>
                                    <a href="<?= base_url('app-admin/profile/edit_akun') ?>" type="button" class="btn btn-sm btn-warning ">Edit Akun</a>
                                </div>
